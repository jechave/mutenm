...
Mutations are modeled as perturbations to the equilibrium lengths of
springs connected to the mutated site. The structural response is
calculated using linear response theory:
...
![](man/figures/README-plot-mrs-1.png)<!-- -->
